<?php
    ...
    // Private Key
    define("SSL_PRIVATE_KEY", openssl_pkey_get_private(file_get_contents(ROOT . 'Storage/PrivateKey.pem')));

	// Pubilc Key
    define("SSL_PUBLIC_KEY", openssl_pkey_get_public(file_get_contents(ROOT . 'Storage/PublicKey.pem')));
